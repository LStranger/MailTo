...
MAILTO_SENT =       "%s 收件人:|cffffff10%s|r (來自 |cffffff10%s|r) %s"
MAILTO_RETURNLIST = "可返回物品:"
MAILTO_RETURN =     "|cffffffff%s|r 收件人:|cffffff10%s|r"
MAILTO_NORETURN =   "為發現可返回物品"
MAILTO_NEW =        "%s%s (來自 |cffffff10%s|r) 收件人:|cffffff10%s|r"
...
MAILTO_INBOX =      "#%d, %s, (來自 |cffffff10%s|r)"
MAILTO_EXPIRES =    "將要過期"
MAILTO_EXPIRED =    "已經過期!"
MAILTO_UNDEFINED =  "未定義指令, "
MAILTO_RECEIVED =   "收到 %s (來自 |cffffff10%s|r), %s"
MAILTO_SALE =       "%s 購買 %s 數量 %s (淨額=%s)."
MAILTO_WON =        "你購買 %s (來自 |cffffff10%s|r) 數量 %s."
MAILTO_NONAME =     "姓名不詳"
MAILTO_NODESC =     "敘述不詳"
